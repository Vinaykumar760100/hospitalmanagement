...
public class PatientControler {
  ...
  //1
   ...
   @GetMapping("/getpatientsbypages")
    public Page<Patients> getpatientsbypages(@RequestParam int page, @RequestParam int size)
   {
              PageRequest pageRequest=  PageRequest.of(page,size);
              return patientService.allpaients(pageRequest);
   }
}
